//
//auto-generated by op_seq_gen.m on 15-May-2012 22:54:40
//
...
void op_par_loop(void (*kernel)( T0* ),
  ...
  op_arg args[1] = { arg0 };
  if(arg0.idx == OP_ALL) {
    p_a[0] = (char *)malloc(args[0].map->dim*sizeof(T0));
  }
...
void op_par_loop(void (*kernel)( T0*, T1* ),
  ...
  if(arg1.idx == OP_ALL) {
    p_a[1] = (char *)malloc(args[1].map->dim*sizeof(T1));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2* ),
  ...
  if(arg2.idx == OP_ALL) {
    p_a[2] = (char *)malloc(args[2].map->dim*sizeof(T2));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3* ),
  ...
  if(arg3.idx == OP_ALL) {
    p_a[3] = (char *)malloc(args[3].map->dim*sizeof(T3));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,
  ...
  if(arg4.idx == OP_ALL) {
    p_a[4] = (char *)malloc(args[4].map->dim*sizeof(T4));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,
  ...
  if(arg5.idx == OP_ALL) {
    p_a[5] = (char *)malloc(args[5].map->dim*sizeof(T5));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,
  ...
  if(arg6.idx == OP_ALL) {
    p_a[6] = (char *)malloc(args[6].map->dim*sizeof(T6));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,
  ...
  if(arg7.idx == OP_ALL) {
    p_a[7] = (char *)malloc(args[7].map->dim*sizeof(T7));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,
  ...
  if(arg8.idx == OP_ALL) {
    p_a[8] = (char *)malloc(args[8].map->dim*sizeof(T8));
  }
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,
  ...
  if(arg9.idx == OP_ALL) {
    p_a[9] = (char *)malloc(args[9].map->dim*sizeof(T9));
  }
