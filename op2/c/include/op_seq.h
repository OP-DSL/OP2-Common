// 
// auto-generated by op_seq_gen.m on 14-Mar-2012 12:55:13 
//
...
void op_par_loop(void (*kernel)( T0* ),                                      
  ...
  if (arg0.argtype==OP_ARG_GBL && arg0.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1* ),                                 
  ...
  if (arg0.argtype==OP_ARG_GBL && arg0.acc!=OP_READ)                         
    op_mpi_reduce(&arg0,(T0 *)p_a[0]);                                       
  if (arg1.argtype==OP_ARG_GBL && arg1.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2* ),                            
  ...
  if (arg1.argtype==OP_ARG_GBL && arg1.acc!=OP_READ)                         
    op_mpi_reduce(&arg1,(T1 *)p_a[1]);                                       
  if (arg2.argtype==OP_ARG_GBL && arg2.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3* ),                       
  ...
  if (arg2.argtype==OP_ARG_GBL && arg2.acc!=OP_READ)                         
    op_mpi_reduce(&arg2,(T2 *)p_a[2]);                                       
  if (arg3.argtype==OP_ARG_GBL && arg3.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                         
  ...
  if (arg3.argtype==OP_ARG_GBL && arg3.acc!=OP_READ)                         
    op_mpi_reduce(&arg3,(T3 *)p_a[3]);                                       
  if (arg4.argtype==OP_ARG_GBL && arg4.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                         
  ...
  if (arg4.argtype==OP_ARG_GBL && arg4.acc!=OP_READ)                         
    op_mpi_reduce(&arg4,(T4 *)p_a[4]);                                       
  if (arg5.argtype==OP_ARG_GBL && arg5.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                         
  ...
  if (arg5.argtype==OP_ARG_GBL && arg5.acc!=OP_READ)                         
    op_mpi_reduce(&arg5,(T5 *)p_a[5]);                                       
  if (arg6.argtype==OP_ARG_GBL && arg6.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                         
  ...
  if (arg6.argtype==OP_ARG_GBL && arg6.acc!=OP_READ)                         
    op_mpi_reduce(&arg6,(T6 *)p_a[6]);                                       
  if (arg7.argtype==OP_ARG_GBL && arg7.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                         
  ...
  if (arg7.argtype==OP_ARG_GBL && arg7.acc!=OP_READ)                         
    op_mpi_reduce(&arg7,(T7 *)p_a[7]);                                       
  if (arg8.argtype==OP_ARG_GBL && arg8.acc!=OP_READ)                         
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                         
  ...
  if (arg8.argtype==OP_ARG_GBL && arg8.acc!=OP_READ)                         
    op_mpi_reduce(&arg8,(T8 *)p_a[8]);                                       
  if (arg9.argtype==OP_ARG_GBL && arg9.acc!=OP_READ)                         
