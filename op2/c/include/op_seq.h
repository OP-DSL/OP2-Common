// 
// auto-generated by op_seq_gen.m on 12-Mar-2012 14:17:49 
//
...
inline void op_arg_set(int n, op_arg arg, char **p_arg, int dont_reduce){                                             
  int n2;                                                                                                             
  ...
  *p_arg = arg.data + n2*arg.size;                                                                                    
  ...
  if (dont_reduce && (arg.argtype==OP_ARG_GBL) && (arg.acc != OP_READ))                                               
    *p_arg = NULL;                                                                                                    
}                                                                                                                     
                                                                                                                      
inline void op_args_set(int iter, int nargs, op_arg *args,                                                            
                        char **p_a, int dont_reduce){                                                                 
  for (int n=0; n<nargs; n++)                                                                                         
    op_arg_set(iter, args[n], &p_a[n], dont_reduce);                                                                  
}                                                                                                                     
...
void op_par_loop(void (*kernel)( T0* ),                                                                               
  ...
  // Calculating set size, MPI halo exchange and dirty bit setting, if needed                                         
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    if (n==set->size) dont_reduce = 1;                                                                                
                                                                                                                      
    op_args_set(n,1,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(1,args);                                                                                    
  // update timer record                                                                                              
...
void op_par_loop(void (*kernel)( T0*, T1* ),                                                                          
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,2,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(2,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2* ),                                                                     
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,3,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(3,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3* ),                                                                
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,4,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(4,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                                                                  
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,5,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(5,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                                                                  
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,6,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(6,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                                                                  
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,7,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(7,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                                                                  
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,8,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(8,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                                                                  
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,9,args,p_a,dont_reduce);                                                                            
  ...
  op_mpi_global_reduction(9,args);                                                                                    
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
...
void op_par_loop(void (*kernel)( T0*, T1*, T2*, T3*,                                                                  
  ...
  for (int n=0; n<n_upper; n++) {                                                                                     
    ...
    op_args_set(n,10,args,p_a,dont_reduce);                                                                           
  ...
  op_mpi_global_reduction(10,args);                                                                                   
  // update timer record                                                                                              
  op_timers(&cpu_t2, &wall_t2);                                                                                       
  #if COMM_PERF                                                                                                       
  int k_i = op_mpi_perf_time(name, wall_t2 - wall_t1);                                                                
