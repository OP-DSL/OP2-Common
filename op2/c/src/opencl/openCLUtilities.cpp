...
cl_platform getPlatform(cl_device_type type, cl_vendor vendor) {
...
cl_context createCLContextFromArguments(int argc, char ** argv) {
...
cl_context createCLContext(cl_device_type type, cl_vendor vendor) {

//    cl_platform platform = getPlatform(type, vendor);
//
...
//
//    try {
//        cl_context context = cl::Context(type, cps);
//
//        return context;
//    } catch(cl_error error) {
//        throw cl_error(1, "Failed to create an OpenCL context!");
//    }
  return 0;
}

cl_program buildProgramFromSource(cl::Context context, std::string filename) {
//        // Read source file
//        std::ifstream sourceFile(filename.c_str());
//        if(sourceFile.fail())
//            throw cl_error(1, "Failed to open OpenCL source file");
//        std::string sourceCode(
//            std::istreambuf_iterator<char>(sourceFile),
//            (std::istreambuf_iterator<char>()));
//        cl_program::Sources source(1, std::make_pair(sourceCode.c_str(), sourceCode.length()+1));
//
