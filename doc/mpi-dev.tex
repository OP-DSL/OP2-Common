...
utilizing its benefits is to read in an unoptimized mesh in an OPS HDF5 file, use the mesh renumbering to optimize the
numbering of this mesh and then use OP2's HDF5 write functions to write the resulting mesh back to a new hdf5 file. The
new hdf5 file can them be used on both single node and distributed memory versions of the application.
...
improve the   performance of codes on hierarchical memory machines}. \em Adv. Eng. Softw. 28 (April 1997), 189--201.
