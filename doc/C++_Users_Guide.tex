...
\begin{routine} {void op\_timings\_to\_csv(char const * file\_path)}
 {Write OP2 performance performance details to csv file. For an MPI code, details broken down by rank. 
 For an OpenMP code generated with the environment variable OP\_TIME\_THREADS set, details broken down by thread.}
