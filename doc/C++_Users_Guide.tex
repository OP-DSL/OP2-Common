...
{This routine transfers control over data from OP2 back to the user.}
\item[dat]           OP dataset ID -- data is put back into the original input array
\end{routine}
...
\begin{routine} {void op\_printf(char *string)}
