...
\begin{tikzpicture}[every node/.style={draw, font=\tt}, node distance=4cm, align=center]
    ...
    \node (jackernels) [right of=jacop]      {jac\_kernels.cpp};
    \node (kernels)    [right of=jackernels] {res\_kernel.cpp\\update\_kernel.cpp};
    \node (libraries)  [right of=kernels]    {libop2\_openmp.a};
