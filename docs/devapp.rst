...
Parallel versions generated by the code generator, as well as the generated sequential version (``gen_seq``), will not work with this flag, since they deallocate the initial memory and move the mesh to achieve optimal parallel performance.
