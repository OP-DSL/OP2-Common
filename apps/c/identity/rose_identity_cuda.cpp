...
int main(int argc,char **argv)
{
  ...
  a_0_host("a_0_modified",Coordinate_elements,op_arg_mat(a_mat,((-1024) - 1),Tracer_element_dofs,((-1024) - 2),Tracer_element_dofs,1,"double",OP_INC),op_arg_gbl(&dt,1,"double",OP_INC),op_arg_dat(Coordinate,(-2),Coordinate_element_dofs,2,"double",OP_READ));
  op_dat L_vec = op_decl_vec(Tracer,"L_vec");
  L_0_host("L_0_modified",Coordinate_elements,op_arg_dat(L_vec,(-2),Tracer_element_dofs,1,"double",OP_INC),op_arg_gbl(&dt,1,"double",OP_INC),op_arg_dat(Coordinate,(-2),Coordinate_element_dofs,2,"double",OP_READ),op_arg_dat(Tracer,(-2),Tracer_element_dofs,1,"double",OP_READ));
