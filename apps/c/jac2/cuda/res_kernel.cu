...
__global__ void op_cuda_res(
  ...
  if (tid + start < end) {
    ...
    res_gpu(arg0+n,
        ...
        arg2_l,
        arg3);
    atomicAdd(&ind_arg1[0*opDat1_res_stride_OP2CONSTANT+map2idx],arg2_l[0]);
    atomicAdd(&ind_arg1[1*opDat1_res_stride_OP2CONSTANT+map2idx],arg2_l[1]);
    atomicAdd(&ind_arg1[2*opDat1_res_stride_OP2CONSTANT+map2idx],arg2_l[2]);
  }
}
