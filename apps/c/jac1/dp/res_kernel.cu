...
__global__ void op_cuda_res(const double *__restrict ind_arg0,
                            double *__restrict ind_arg1,
                            const int *__restrict opDat1Map,
                            const double *__restrict arg0, const double *arg3,
                            int *ind_map, short *arg_map, int *ind_arg_sizes,
                            int *ind_arg_offs, int block_offset, int *blkmap,
                            int *offset, int *nelems, int *ncolors, int *colors,
    ...
    for (int col = 0; col < Plan->ncolors; col++) {
      ...
      if (Plan->ncolblk[col] > 0) {
        ...
        op_cuda_res<<<nblocks, nthread, nshared>>>(
            (double *)arg1.data_d, (double *)arg2.data_d, arg1.map_data_d,
            (double *)arg0.data_d, (double *)arg3.data_d, Plan->ind_map,
