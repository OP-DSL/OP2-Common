...
#endif
inline void adt_calc_vec( const long double x1[][SIMD_VEC], const long double x2[][SIMD_VEC], const long double x3[][SIMD_VEC], const long double x4[][SIMD_VEC], const long double q[][SIMD_VEC], long double adt[][SIMD_VEC], int idx ) {
  long double dx, dy, ri, u, v, c;
...
void op_par_loop_adt_calc(char const *name, op_set set,
  ...
  ALIGNED_long_double       long double * __restrict__ ptr5 = (long double *) arg5.data;
  ...
  if (exec_size >0) {
    ...
    for ( int n=0; n<(exec_size/SIMD_VEC)*SIMD_VEC; n+=SIMD_VEC ){
      ...
      ALIGNED_long_double long double dat2[2][SIMD_VEC];
      ALIGNED_long_double long double dat3[2][SIMD_VEC];
