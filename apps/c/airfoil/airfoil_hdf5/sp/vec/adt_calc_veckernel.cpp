...
#endif
inline void adt_calc_vec( const float x1[][SIMD_VEC], const float x2[][SIMD_VEC], const float x3[][SIMD_VEC], const float x4[][SIMD_VEC], const float q[][SIMD_VEC], float adt[][SIMD_VEC], int idx ) {
  float dx, dy, ri, u, v, c;
