...
#endif
inline void res_calc_vec( const double x1[][SIMD_VEC], const double x2[][SIMD_VEC], const double q1[][SIMD_VEC], const double q2[][SIMD_VEC], const double adt1[][SIMD_VEC], const double adt2[][SIMD_VEC], float res1[][SIMD_VEC], float res2[][SIMD_VEC], int idx ) {
  double dx, dy, mu, ri, p1, vol1, p2, vol2, f;
