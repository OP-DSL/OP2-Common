...
inline void bres_calc(__global float *x1, __global float *x2, __global float *q1,
                      __global float *adt1, float *res1, __global int *bound, float gm1, float eps, __constant float* qinf) {
