...
//extern __constant double gam;
//extern __constant double gm1;
//extern __constant double cfl;

//void adt_calc(__local double *x1, __local double *x2, __local double *x3, __local double *x4, __global double *q, __global double *adt,
...
//  for (int n=get_local_id(0); n<nelem; n+=get_local_size(0)) {
    ...
    map3idx = ind_arg0_map_data[n + offset_b + set_size * 3];
      ...
      //__local double *x3 = ind_arg0_s+arg_map[2*set_size+n+offset_b]*2;
      //__local double *x4 = ind_arg0_s+arg_map[3*set_size+n+offset_b]*2;
      //__global double *q = arg4+(n+offset_b)*4;
      //__global double *adt = arg5+(n+offset_b)*1;
...
////    arg5[get_global_id(0)] = (double)ind_arg0_s[get_local_id(0)-10];
////
////  return;
//
////  arg5[get_global_id(0)] = (double)get_global_id(0);
////  if(ind_arg0_s == 0) {
