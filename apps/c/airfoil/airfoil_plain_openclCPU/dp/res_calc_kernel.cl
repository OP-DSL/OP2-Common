...
inline void res_calc(__global const double * restrict x1, __global const double * restrict x2, __global const  double * restrict q1, __global const  double * restrict q2,
                      __global const double * restrict adt1, __global const double * restrict adt2, double * restrict res1, double * restrict res2, double gm1, double eps) {
...
__kernel void op_opencl_res_calc(
  __global const double* restrict ind_arg0,
  __global const double* restrict ind_arg1,
  __global const double* restrict ind_arg2,
...
//                 *eps);
//
////       __local double *x1 = ind_arg0_s+arg_map[0*set_size+n+offset_b]*2;
////       __local double *x2 = ind_arg0_s+arg_map[1*set_size+n+offset_b]*2;
////       __local double *q1 = ind_arg1_s+arg_map[2*set_size+n+offset_b]*4;
////       __local double *q2 = ind_arg1_s+arg_map[3*set_size+n+offset_b]*4;
////       __local double *adt1 = ind_arg2_s+arg_map[4*set_size+n+offset_b]*1;
////       __local double *adt2 = ind_arg2_s+arg_map[5*set_size+n+offset_b]*1;
////       double *res1 = arg6_l;
////       double *res2 = arg7_l;
////
////       double dx,dy,mu, ri, p1,vol1, p2,vol2, f;
...
//
//inline void res_calc(__local double *x1, __local double *x2, __local  double *q1, __local  double *q2,
//                      __local double *adt1, __local double *adt2, double *res1, double *res2, double gm1, double eps) {
//
//  double dx,dy,mu, ri, p1,vol1, p2,vol2, f;
//
//  dx = x1[0] - x2[0];
