	.file	"/tmp/41fc4fdd-1a14-4109-a208-4ff53d428990.TMP"
...
# BB#44:                                # %thenBB433
                                        #   in Loop: Header=BB0_1 Depth=1
	cmp	DWORD PTR [RSP - 44], 3 # 4-byte Folded Reload
	je	.LBB0_21
...
# BB#4:                                 #   in Loop: Header=BB0_2 Depth=2
	...
	mov	EAX, DWORD PTR [RAX + 4*R11]
	mov	DWORD PTR [RSI + 1152], EAX
	mov	RBX, QWORD PTR [RCX + 56]
	test	RBX, RBX
	mov	R14, RBX
	mov	EAX, 1
	cmove	R14, RAX
	mov	EAX, DWORD PTR [RSI + 768]
	dec	EAX
	movsxd	RAX, EAX
	xor	EDX, EDX
	div	R14
...
.LBB0_15:                               # %bb.nph47
	...
	movss	DWORD PTR [R10 + 4*RAX], XMM0
	mov	EAX, EDX
...
.LBB0_19:                               # %._crit_edge43
	...
	cmp	R8, QWORD PTR [RSP + 256]
	jb	.LBB0_7
# BB#20:                                # %._crit_edge43.SyncBB415_crit_edge
                                        #   in Loop: Header=BB0_1 Depth=1
	mov	DWORD PTR [RSP - 44], 3 # 4-byte Folded Spill
	xor	R8D, R8D
	mov	R9, R8
.LBB0_21:                               # %SyncBB415
                                        #   in Loop: Header=BB0_1 Depth=1
...
# BB#4:                                 #   in Loop: Header=BB1_2 Depth=2
	...
	mov	EBX, DWORD PTR [RDX + 4*RAX]
	mov	DWORD PTR [R8 + 640], EBX
	lea	R14D, DWORD PTR [4*R11 + 1]
	movsxd	R14, R14D
	movsxd	R15, DWORD PTR [RDX + 4*R14]
	mov	DWORD PTR [R8 + 1664], R15D
	lea	R12D, DWORD PTR [4*R11 + 2]
	movsxd	R12, R12D
	mov	R13D, DWORD PTR [RDX + 4*R12]
	mov	DWORD PTR [R8 + 896], R13D
	lea	R11D, DWORD PTR [4*R11 + 3]
	movsxd	R11, R11D
	mov	EDX, DWORD PTR [RDX + 4*R11]
	mov	DWORD PTR [R8 + 1408], EDX
	...
	lea	RAX, QWORD PTR [RBP + 4*RAX]
	mov	QWORD PTR [R8 + 1024], RAX
	movsxd	RAX, DWORD PTR [RDX + 4*R12]
	add	RAX, QWORD PTR [RSP - 24] # 8-byte Folded Reload
	lea	RAX, QWORD PTR [RBP + 4*RAX]
	mov	QWORD PTR [R8 + 1920], RAX
	movsxd	RAX, DWORD PTR [RDX + 4*R11]
	add	RAX, QWORD PTR [RSP - 16] # 8-byte Folded Reload
	lea	RAX, QWORD PTR [RBP + 4*RAX]
...
.LBB1_15:                               # %bb.nph47
	...
	movss	XMM0, DWORD PTR [RBX + 4*R11]
