...
//    shared[n] = ind_arg0[n%2+ind_arg0_map[n/2]*2];
//      ind_arg0_s[n] = 1.0f;
  //    ind_arg0_s[1] = 1.0f;
//    ind_arg0[n] = ind_arg0[n%2+ind_arg0_map[n/2]*2];;
...
//  for (int n=threadIdx.x; n<nelem; n+=blockDim.x) {
      ...
      adt_calc(  ind_arg0_s+arg_map[0*set_size+n+offset_b]*2,
                 ...
                 *gm1,
                 *cfl);
//    adt_calc(  shared+arg_map[0*set_size+n+offset_b]*2,
//        shared+arg_map[1*set_size+n+offset_b]*2,
//        shared+arg_map[2*set_size+n+offset_b]*2,
//        shared+arg_map[3*set_size+n+offset_b]*2,
//               arg4+(n+offset_b)*4,
//               arg5+(n+offset_b)*1,
//               *gam,
//               *gm1,
//               *cfl);
//      __local float* a = (__local float*) ind_arg0_s+arg_map[0*set_size+n+offset_b]*2;
//      __private int a = (int)ind_arg0_s;
//      arg5[get_global_id(0)] = (float)*a;

//      arg5[(n+offset_b)*1] = (float)a;
//      if (get_local_id(0) == 0) {
//        arg5[(n+offset_b)*1] = 0.1;
//        blockId = blkmap[get_group_id(0) + get_group_id(1)*get_num_groups(0)  + block_offset];
//
//        nelem    = nelems[blockId];
//        offset_b = offset[blockId];
