//
// auto-generated by op2.m on 11-Jul-2012 04:55:04
//
...
void op_par_loop_res_calc(char const *name, op_set set,
  ...
  double arg8_l[1+64*64];
  for (int thr=0; thr<nthreads; thr++)
    for (int d=0; d<1; d++) arg8_l[d+thr*64]=ZERO_double;
...
#pragma omp parallel for
  ...
  for (int thr=0; thr<nthreads; thr++)
    for(int d=0; d<1; d++) arg8h[d] += arg8_l[d+thr*64];
