  ...
  if (set->size > 0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      op2_queue->submit([&](cl::sycl::handler& cgh) {
        ...
        auto qinf= (*qinf_p).template get_access<cl::sycl::access::mode::read>(cgh);
        ...
        auto bres_calc_gpu = [=]( const double *x1, const double *x2, const double *q1,
            ...
            p1 = gm1[0] * (q1[(3)*opDat2_bres_calc_stride_OP2CONSTANT] - 0.5f * ri * (q1[(1)*opDat2_bres_calc_stride_OP2CONSTANT] * q1[(1)*opDat2_bres_calc_stride_OP2CONSTANT] + q1[(2)*opDat2_bres_calc_stride_OP2CONSTANT] * q1[(2)*opDat2_bres_calc_stride_OP2CONSTANT]));
