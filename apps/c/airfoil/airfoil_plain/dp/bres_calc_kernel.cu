...
// user function
__device__ void bres_calc_gpu(const double *x1, const double *x2,
...
__global__ void op_cuda_bres_calc(
    const double *__restrict ind_arg0, const double *__restrict ind_arg1,
    const double *__restrict ind_arg2, double *__restrict ind_arg3,
    const int *__restrict opDat0Map, const int *__restrict opDat2Map,
    const int *__restrict arg5, int *ind_map, short *arg_map,
    int *ind_arg_sizes, int *ind_arg_offs, int block_offset, int *blkmap,
    int *offset, int *nelems, int *ncolors, int *colors, int nblocks,
    int set_size) {
  double arg4_l[4];
  ...
  for (int n = threadIdx.x; n < nelems2; n += blockDim.x) {
    ...
    if (n < nelem) {
      ...
      bres_calc_gpu(ind_arg0 + map0idx * 2, ind_arg0 + map1idx * 2,
                    ind_arg1 + map2idx * 4, ind_arg2 + map2idx * 1, arg4_l,
                    arg5 + (n + offset_b) * 1);
    ...
    for (int col = 0; col < Plan->ncolors; col++) {
      ...
      if (Plan->ncolblk[col] > 0) {
        ...
        op_cuda_bres_calc<<<nblocks, nthread, nshared>>>(
            (double *)arg0.data_d, (double *)arg2.data_d, (double *)arg3.data_d,
            (double *)arg4.data_d, arg0.map_data_d, arg2.map_data_d,
            (int *)arg5.data_d, Plan->ind_map, Plan->loc_map, Plan->ind_sizes,
