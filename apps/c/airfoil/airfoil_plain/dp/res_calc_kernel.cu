...
// user function
__device__ void res_calc_gpu(const double *x1, const double *x2,
    ...
    for (int col = 0; col < Plan->ncolors; col++) {
      ...
      if (Plan->ncolblk[col] > 0) {
        ...
        op_cuda_res_calc<<<nblocks, nthread, nshared>>>(
            (double *)arg0.data_d, (double *)arg2.data_d, (double *)arg4.data_d,
            (double *)arg6.data_d, arg0.map_data_d, arg2.map_data_d,
