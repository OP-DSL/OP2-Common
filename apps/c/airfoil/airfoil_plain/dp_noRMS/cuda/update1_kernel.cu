...
//user function
__device__ void update1_gpu( const double *qold, double *q, double *res,
...
__global__ void op_cuda_update1(
...
void op_par_loop_update1(char const *name, op_set set,
  ...
  if (OP_diags>2) {
    printf(" kernel routine w/o indirection:  update1");
  }
  ...
  if (set->size > 0) {
    ...
    op_cuda_update1<<<nblocks,nthread,nshared>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
