...
__global__ void op_cuda_res_calc(
  ...
  for ( int n=threadIdx.x; n<nelems2; n+=blockDim.x ){
    ...
    for ( int col=0; col<ncolor; col++ ){
      if (col2==col) {
        arg0_l[0] += ind_arg0[0*opDat0_res_calc_stride_OP2CONSTANT+map0idx];
        arg0_l[1] += ind_arg0[1*opDat0_res_calc_stride_OP2CONSTANT+map0idx];
        arg0_l[2] += ind_arg0[2*opDat0_res_calc_stride_OP2CONSTANT+map0idx];
        arg0_l[3] += ind_arg0[3*opDat0_res_calc_stride_OP2CONSTANT+map0idx];
        ind_arg0[0*opDat0_res_calc_stride_OP2CONSTANT+map0idx] = arg0_l[0];
        ind_arg0[1*opDat0_res_calc_stride_OP2CONSTANT+map0idx] = arg0_l[1];
        ind_arg0[2*opDat0_res_calc_stride_OP2CONSTANT+map0idx] = arg0_l[2];
        ind_arg0[3*opDat0_res_calc_stride_OP2CONSTANT+map0idx] = arg0_l[3];
      }
      __syncthreads();
    }
  }
