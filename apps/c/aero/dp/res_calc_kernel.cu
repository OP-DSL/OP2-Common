...
__global__ void op_cuda_res_calc(
  ...
  for (int n=threadIdx.x; n<nelems2; n+=blockDim.x) {
    ...
    if (n<nelem) {
      ...
      res_calc(  arg0_vec, arg1_vec, arg8+(n+offset_b), arg2_vec, stride);
    ...
    // store local variables
      ...
      if (col2>=0) {
        arg9_map = arg9_maps[n+offset_b];
        arg10_map = arg10_maps[n+offset_b];
        arg11_map = arg11_maps[n+offset_b];
        arg12_map = arg12_maps[n+offset_b];
      }
    ...
    for (int col=0; col < Plan->ncolors; col++) {
      ...
      int nshared = Plan->nshared;
        op_cuda_res_calc<<<nblocks,nthread,nshared>>>(
           ...
           (double *)arg9.data_d, Plan->ind_maps[2],
           Plan->loc_maps[0],
           Plan->loc_maps[1],
           Plan->loc_maps[2],
           Plan->loc_maps[3],
