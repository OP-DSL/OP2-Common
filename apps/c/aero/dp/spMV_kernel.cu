...
void op_par_loop_spMV(char const *name, op_set set,
  ...
  arg0.idx = 0;
  op_arg arg1 = op_arg_dat(arg0.dat, 1, arg0.map, 1, "double", OP_INC);
  op_arg arg2 = op_arg_dat(arg0.dat, 2, arg0.map, 1, "double", OP_INC);
  op_arg arg3 = op_arg_dat(arg0.dat, 3, arg0.map, 1, "double", OP_INC);
  arg5.idx = 0;
  op_arg arg6 = op_arg_dat(arg5.dat, 1, arg5.map, 1, "double", OP_READ);
  op_arg arg7 = op_arg_dat(arg5.dat, 2, arg5.map, 1, "double", OP_READ);
  op_arg arg8 = op_arg_dat(arg5.dat, 3, arg5.map, 1, "double", OP_READ);
