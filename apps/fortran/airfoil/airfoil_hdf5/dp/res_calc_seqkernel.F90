...
! kernel call
  CALL res_calc( &
    ...
    & opDat3Local(1 + opDat3Map(i1 * opDat3MapDim + 2) * (4) : opDat3Map(i1 * opDat3MapDim + 2) * (4) + 4), &
    & opDat5Local(1 + opDat5Map(i1 * opDat5MapDim + 1)), &
    & opDat5Local(1 + opDat5Map(i1 * opDat5MapDim + 2)), &
    & opDat7Local(1 + opDat7Map(i1 * opDat7MapDim + 1) * (4) : opDat7Map(i1 * opDat7MapDim + 1) * (4) + 4), &
    & opDat7Local(1 + opDat7Map(i1 * opDat7MapDim + 2) * (4) : opDat7Map(i1 * opDat7MapDim + 2) * (4) + 4) &
    & )
  END DO
