...
SUBROUTINE bres_calc_vec(x1,x2,q1,adt1,res1,bound)
  ...
  integer(4), DIMENSION(SIMD_VEC,1), INTENT(IN) :: bound
...
SUBROUTINE op_wrap_bres_calc( &
  ...
  DO i1 = bottom, ((top-1)/SIMD_VEC)*SIMD_VEC-1, SIMD_VEC
    ...
    DO i2 = 1, SIMD_VEC-1, 1
      ...
      map4idx = opDat3Map(1 + i(i1+i2-1) * opDat3MapDim + 0) + 1
