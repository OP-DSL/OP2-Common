...
SUBROUTINE op_wrap_bres_calc( &
  ...
  !$acc routine(bres_calc)


  !$acc parallel loop independent gang vector deviceptr( opDat1Local, opDat3Local, opDat4Local, opDat5Local, opDat6Local, opDat1Map, opDat3Map, col_reord) private(i1, map1idx, map2idx, map3idx)
