!
! auto-generated by op2.py on 2013-02-19 10:13
!
...
program AIRFOIL
  ...
  do niter = 1, iterationNumber
    ...
    do k = 1, 2
      ...
      call res_calc_host(C_CHAR_'res_cala'//C_NULL_CHAR,edges, &
      ...
      call bres_calc_host(C_CHAR_'bres_cala'//C_NULL_CHAR,bedges, &
