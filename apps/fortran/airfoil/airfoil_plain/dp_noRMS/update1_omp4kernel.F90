...
! user function
SUBROUTINE update1_gpu(qold,q,res,adt,rms)
  IMPLICIT NONE
...
END SUBROUTINE
SUBROUTINE update1_host( userSubroutine, set, &
  & opArg1, &
  & opArg2, &
  & opArg3, &
  & opArg4, &
