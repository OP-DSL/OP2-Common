...
GENERATED := $(APP_NAME)_op.cpp $(APP_NAME)_mpi_op.cpp \
...
$(GENERATED)&: $(APP_NAME).cpp $(APP_NAME)_mpi.cpp
...
$(APP_NAME)_mpi_seq: $(APP_NAME)_mpi.cpp
	$(MPICXX) $(CXXFLAGS) $(OP2_INC) $^ $(OP2_LIB_MPI) $(PARMETIS_LIB) $(PTSCOTCH_LIB) -o $@
...
$(APP_NAME)_mpi_vec: $(APP_NAME)_mpi_op.cpp vec/$(APP_NAME)_mpi_veckernels.cpp
	$(MPICXX) $(CXXFLAGS) -DVECTORIZE $(OMP_CPPFLAGS) $(OP2_INC) $^ $(OP2_LIB_MPI) $(PARMETIS_LIB) $(PTSCOTCH_LIB) -o $@
...
$(APP_NAME)_mpi_openmp: $(APP_NAME)_mpi_op.cpp openmp/$(APP_NAME)_mpi_kernels.cpp
	$(MPICXX) $(CXXFLAGS) $(OMP_CPPFLAGS) $(OP2_INC) $^ $(OP2_LIB_MPI) $(PARMETIS_LIB) $(PTSCOTCH_LIB) -o $@
...
$(APP_NAME)_mpi_openmp4: $(APP_NAME)_mpi_op.cpp openmp4/$(APP_NAME)_mpi_omp4kernels.cpp
	$(MPICXX) $(CXXFLAGS) $(OMP4_CPPFLAGS) $(OP2_INC) $^ $(OP2_LIB_MPI) $(PARMETIS_LIB) $(PTSCOTCH_LIB) -o $@

cuda/%_kernels.o: cuda/%_kernels.cu
	$(NVCC) $(NVCCFLAGS) $(OP2_INC) -c $^ -o $@

$(APP_NAME)_cuda: $(APP_NAME)_op.cpp cuda/$(APP_NAME)_kernels.o
	$(CXX) $(CXXFLAGS) $(OP2_INC) $^ $(OP2_LIB_CUDA) $(CUDA_LIB) -o $@

$(APP_NAME)_mpi_cuda: $(APP_NAME)_mpi_op.cpp cuda/$(APP_NAME)_mpi_kernels.o
	$(MPICXX) $(CXXFLAGS) $(OP2_INC) $^ $(OP2_LIB_MPI_CUDA) $(CUDA_LIB) $(PARMETIS_LIB) $(PTSCOTCH_LIB) -o $@
...
$(APP_NAME)_cuda_hyb: $(APP_NAME)_op.cpp cuda/$(APP_NAME)_hybkernels_gpu.o cuda/$(APP_NAME)_hybkernels_cpu.o
	$(CXX) $(CXXFLAGS) $(OMP_CPPFLAGS) $(OP2_INC) $^ $(OP2_LIB_CUDA) $(CUDA_LIB) -o $@

$(APP_NAME)_mpi_cuda_hyb: $(APP_NAME)_op.cpp cuda/$(APP_NAME)_mpi_hybkernels_gpu.o cuda/$(APP_NAME)_mpi_hybkernels_cpu.o
	$(MPICXX) $(CXXFLAGS) $(OMP_CPPFLAGS) $(OP2_INC) $^ $(OP2_LIB_MPI_CUDA) $(CUDA_LIB) $(PARMETIS_LIB) $(PTSCOTCH_LIB) -o $@
